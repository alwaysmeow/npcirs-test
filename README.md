...
Тестовое fullstack-приложение на `Node.js + React + PostgreSQL` для учета фильмов и сеансов в кинотеатре.

Проект реализует:
- главную таблицу `movies` и связанную таблицу `sessions` для киносеансов
- CRUD для сеансов
- серверное REST-API
...
- Для `sessions` доступны операции:
  ...
  - изменение
  - удаление
- При создании и редактировании киносеанса учитывается связь с таблицей фильмов
